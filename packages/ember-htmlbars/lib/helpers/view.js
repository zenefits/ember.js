...
function viewHelper(params, options, env) {
  ...
  if (!viewClassOrName) {
    Ember.assert('{{view}} helper requires parent view to have a container but none was found. This usually happens when you are manually-managing views.', !!parentView.container);
    viewClassOrName = parentView.container.lookupFactory('view:default');
  }
