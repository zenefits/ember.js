...
*/
function collectionHelper(params, options, env) {
  ...
  if (hash.keyword) {
    itemHash._context = alias('_parentView.context'); // FIXME: double check this is right
  } else {
  ...
  return env.helpers.view([collectionClass], options, env);
}
