...
/**
  ...
  @private
*/
export var _Morph = Mixin.create({
  isVirtual: true,
  tagName: '',

  instrumentName: 'morph',
  ...
  createElement: function() {
    ...
    // this.morph.update(buffer.string());
    // this.clearBuffer();
  },
...
/**
  ...
  @private
*/
export var _MorphView = View.extend(_Morph);
...
/**
  ...
  @private
*/
export var _SimpleMorphView = CoreView.extend(_Morph);
