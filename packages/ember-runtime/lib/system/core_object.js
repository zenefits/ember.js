...
function makeCtor() {
  ...
  var Class = function() {
    ...
    o_defineProperty(self, GUID_KEY, undefinedDescriptor);
    o_defineProperty(self, '_super', undefinedDescriptor);
    m.proto = self;
    if (initMixins) {
      this.reopen.apply(self, initMixins);
      initMixins = null;
    }
    finishPartial(self, m);
    delete m.proto;
    finishChains(self);
